...
<body id="Login" style="margin: 0;height: 100%;overflow-x: hidden;">
    ...
    <div class="Login_Vcenter" id="Login_Comp">
        ...
        if (isset($_GET['source'])) {
            if ($_GET['source'] == "created") {
                echo($lang_new_signup_login);
            } else {
                echo("<small><a href=\"/@/signup/?lang={$lang}{$oauth_back}\" class=\"Signup_Privacy\">{$lang_new_login_switch}</a></small>");
            }
        } else {
            echo("<small><a href=\"/@/signup/?lang={$lang}{$oauth_back}\" class=\"Signup_Privacy\">{$lang_new_login_switch}</a></small>");
        }
        ...
        ?>
        <br><br>
        <span id="Login_Title"><?= $lang_new_login_login ?></span><br><small><?= $lang_new_continue_oauth2 ?></small><br>
        <input placeholder="<?= $lang_new_login_user ?>" class="Login_Input" id="Login_User">
        <input placeholder="<?= $lang_new_login_pass ?>" type="password" class="Login_Input hide" id="Login_Password"><br><br>
