...
function nextPage() {
    ...
    setTimeout(() => {
        if (document.getElementById('Login_User').value.trim() == "") {
            ...
            document.getElementById('Login_PasswordConfirm').classList.remove('hide')
            document.getElementById('Login_User').classList.add('hide')
            document.getElementById('Login_Title').innerHTML = lang_new_signup_confirm + document.getElementById('Login_User').value
            setTimeout(() => {
                $("#Login_Loader").fadeOut(2000)
                $("#Login_Comp").fadeIn(2000)
            }, 2000)
